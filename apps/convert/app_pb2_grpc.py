...
class AppServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetResult = channel.unary_unary(
                '/app.AppService/GetResult',
                request_serializer=app__pb2.Request.SerializeToString,
                response_deserializer=app__pb2.ResultList.FromString,
                _registered_method=True)
...
def add_AppServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetResult': grpc.unary_unary_rpc_method_handler(
                    servicer.GetResult,
                    request_deserializer=app__pb2.Request.FromString,
                    response_serializer=app__pb2.ResultList.SerializeToString,
            ),
    }
...
class AppService(object):
    ...
    def GetResult(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/app.AppService/GetResult',
            app__pb2.Request.SerializeToString,
            app__pb2.ResultList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
